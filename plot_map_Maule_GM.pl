...
`gmt psbasemap -R$area -JL$area_L -Ba5f2.5g2.5WSen -O -K >> $fileout".ps"`;  #use this instead for directly copy the base
    ...
    #$pred_shake = `ls /Users/timlin/TEST_MLARGE/GMTinp_Test030_GM_Pred/Test031.case0000002.epo${epo}.shake`; chomp($pred_shake);
...
$pred_fault = `ls /Users/timlin/TEST_MLARGE/GMTinp_Test031_GM_Pred/Test031.case0000002.epo${epo}.fault`; chomp($pred_fault);
...
`cat $fault | awk 'NR>1{print(\$2,\$3,\$4)}' | gmt pscontour -R -J  -A10,20,30+u" km" -C10,20,30 -W0.5p,50/50/50,-- -O -K >>$fileout".ps"`;
...
#East/North/Up
`gmt gmtset MAP_ANNOT_OFFSET_PRIMARY 0p MAP_LABEL_OFFSET 2.5p FONT_LABEL 14p FONT_ANNOT_PRIMARY 12p`;
`gmt psbasemap -R0/510/-40/-20 -JX2.5i/3.2i -Ba200f100g100:"Time(s)":/a5f2.5:"Lat.":WSen -G255/255/255 -K -O -Y-6.18i -X4.95i >>${fileout}.ps`;
...
###### plot parameter predictions #######
    ...
    $pred_file='/Users/timlin/TEST_MLARGE/pred_parameters_Test031.txt';
